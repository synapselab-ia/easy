...
describe('buildDashboardSnapshot', () => {
    it('centralizes month flow, as-of-today debt, FIFO aging and deduplicated attention rows', () => {
        ...
        const transactions: Transaction[] = [
            transaction({
                ...
                totalPrice: 100,
                quantity: 1,
                occurredAt: new Date(2026, 6, 20, 10, 0, 0),
            }),
            transaction({
                id: 2,
                resellerId: 1,
                ...
                totalPrice: 50,
                quantity: 1,
                occurredAt: new Date(2026, 7, 10, 10, 0, 0),
            }),
            transaction({
                id: 3,
                resellerId: 1,
                type: 'payment',
                totalPrice: 30,
                occurredAt: new Date(2026, 7, 15, 10, 0, 0),
            }),
            transaction({
                id: 4,
                resellerId: 1,
                ...
                totalPrice: 20,
                quantity: 2,
                occurredAt: new Date(2026, 7, 27, 10, 0, 0),
                createdAt: new Date(2026, 7, 27, 10, 5, 0),
            }),
            transaction({
                id: 5,
                resellerId: 2,
                ...
                totalPrice: 80,
                quantity: 4,
                occurredAt: new Date(2026, 7, 5, 10, 0, 0),
            }),
            transaction({
                id: 6,
                resellerId: 2,
                type: 'payment',
                totalPrice: 10,
                occurredAt: new Date(2026, 7, 12, 10, 0, 0),
            }),
            transaction({
                id: 7,
                resellerId: 2,
                type: 'payment',
                totalPrice: 60,
                occurredAt: new Date(2026, 7, 28, 10, 0, 0),
                createdAt: new Date(2026, 7, 27, 11, 0, 0),
            }),
            transaction({
                id: 8,
                resellerId: 3,
                ...
                totalPrice: 500,
                quantity: 5,
                occurredAt: new Date(2026, 7, 30, 10, 0, 0),
                createdAt: new Date(2026, 7, 27, 11, 30, 0),
            }),
            transaction({
                id: 9,
                resellerId: 3,
                ...
                totalPrice: 999,
                quantity: 9,
                occurredAt: new Date(2026, 7, 27, 9, 0, 0),
                createdAt: new Date(2026, 7, 27, 11, 45, 0),
        ...
        // The future order and future payment are valid registrations, but neither
        // changes current debt or month-to-today flow before its occurrence date.
        ...
        // Ana has both critical and attention lots but appears only once, as critical.
    ...
    it('orders attention rows by severity, oldest determining debt, alert amount and reseller name', () => {
        const asOf = new Date(2026, 7, 27, 12, 0, 0);
        const resellers = [
            reseller(1, 'Zulu'),
            reseller(2, 'Ana'),
